...
// Lógica para o formulário de contato (Fale Conosco)
document.addEventListener('DOMContentLoaded', function() {
    const contactForm = document.getElementById('contactForm');
    const contactSuccessMessage = document.getElementById('contactSuccessMessage');

    if (contactForm) { // Garante que o formulário existe na página
        contactForm.addEventListener('submit', function(event) {
            event.preventDefault(); // Impede o envio padrão do formulário e a recarga da página

            // Aqui, em um cenário real, você enviaria os dados do formulário para um servidor.
            ...
            // Opcional: Faz a mensagem desaparecer após alguns segundos
            setTimeout(() => {
                contactSuccessMessage.style.display = 'none';
            }, 5000); // A mensagem sumirá após 5 segundos
        });
    }
});